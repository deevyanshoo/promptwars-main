  ...
  const nodes = [
    {
      ...
      async run({ input }) {
        return {
          ...
          clarification: validateClarification(input.clarification),
        };
      },
    },
    {
      ...
      async run({ signal }, deps) {
        return validateExplanation(
          await generate({
            ...
            clarification: deps.validate_input.clarification,
